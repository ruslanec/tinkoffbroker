...
func TestWithServices(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := WithServices(tt.args.s); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("WithServices() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestWithUsers(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := WithUsers(tt.args.s); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("WithUsers() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestWithStopOrders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := WithStopOrders(tt.args.s); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("WithStopOrders() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestWithOrders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := WithOrders(tt.args.s); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("WithOrders() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestWithOrdersStream(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := WithOrdersStream(tt.args.s); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("WithOrdersStream() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestWithOperations(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := WithOperations(tt.args.s); !reflect.DeepEqual(got, tt.want) {
...
func TestWithMarketData(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := WithMarketData(tt.args.s); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("WithMarketData() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestWithMarketDataStream(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := WithMarketDataStream(tt.args.s); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("WithMarketDataStream() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestWithInstruments(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := WithInstruments(tt.args.s); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("WithInstruments() = %v, want %v", got, tt.want)
			}
		})
	}
}
