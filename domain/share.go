...
const (
	ShareTypeUnspecified   ShareType = 0 // Значение не определено.
	ShareTypeCommon        ShareType = 1 // Обыкновенная
	ShareTypePreferred     ShareType = 2 // Привилегированная
	ShareTypeADR           ShareType = 3 // Американские депозитарные расписки
	ShareTypeGDR           ShareType = 4 // Глобальные депозитарные расписки
	ShareTypeMLP           ShareType = 5 // Товарищество с ограниченной ответственностью
	ShareTypeNYRegShares   ShareType = 6 // Акции из реестра Нью-Йорка
	ShareTypeClosedEndFund ShareType = 7 // Закрытый инвестиционный фонд
	ShareTypeReit          ShareType = 8 // Траст недвижимости
)
